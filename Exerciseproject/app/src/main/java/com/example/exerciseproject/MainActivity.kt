...
@Composable
fun AppNavComposable(viewModel: BlockNoteViewModel = viewModel()){
...
@Composable
fun HomeScreen(navController: NavController, viewModel: BlockNoteViewModel){
    Scaffold(
        topBar = {
            TopAppBar(
...
@Composable
fun ListOfNotes(navController: NavController,  modifier: Modifier = Modifier, viewModel: BlockNoteViewModel) {
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun DetailScreen(navController: NavController, appBarTitle: String, id: Int?, viewModel: BlockNoteViewModel) {
    val noteInfo: NoteInfo? = if(id != null) viewModel.getModelById(id) else
